define(["app/config", "app/utils", "app/statistics"], function (config, appUtils, statistics) {
  ...
  function createYearChart() {
    ...
    const yearChart = new Chart(yearCanvas.getContext("2d"), {
      ...
      options: {
        ...
        title: {
          display: true,
          text: "Edificios por año de construcción - total"
        },
        scales: {
          xAxes: [
            {
  ...
  function createHeightChart() {
    ...
    return new Chart(heightCanvas.getContext("2d"), {
      ...
      options: {
        ...
        title: {
          display: true,
          text: "Edificios por altura - total"
        },
        scales: {
          xAxes: [
            {
  ...
  function createUsageChart() {
    ...
    const usageChart = new Chart(usageCanvas.getContext("2d"), {
      ...
      options: {
        ...
        title: {
          display: true,
          text: "Utilización de edificaciones - total"
        }
      }
    });
    return usageChart;
  ...
  return {
    ...
    updateCharts(result, selection) {
      ...
      const yearTitle = selection ? "Edificios por año de construcción - selección" : "Edificios por año de construcción - total"
      ...
      const heightTitle = selection ? "Edificios por altura - selección" : "Edificios por altura - total"
      ...
      const usageTitle = selection ? "Utilización de edificaciones - selección" : "Utilización de edificaciones - total"
